    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_weazel', _U('billing'), amount)
        end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_journalist:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_journalist:removeVaultWeapon', function()
          OpenGetWeaponMenu()
